...
export default class LockableCharacterSheet extends LockableSheet {
  ...
  getXPInputs(sheetElem) {
    return {
      elements: sheetElem.querySelectorAll('input[name="system.details.xp.value"]'),
      lockMode: LockMode.FORM_DISABLED,
    };
  }

  getLevelUpButton(sheetElem) {
    return {
      elements: sheetElem.querySelectorAll('button[title="Level Up"]'),
      lockMode: LockMode.FORM_DISABLED,
    };
  }
