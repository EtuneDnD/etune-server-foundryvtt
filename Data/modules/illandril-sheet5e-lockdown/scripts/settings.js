...
const Settings = {
  ...
  LockToggleStyle: new ChoiceSetting('lockToggleStyle', 'iconOnly', LockToggleStyles, { scope: 'client' }),

  // Basic Details
  LockName: new BooleanSetting('lockName', true),
  ...
  LockLevelUp: new BooleanSetting('lockLevelUp', true),
  ...
  LockEquipItemButtons: new BooleanSetting('lockEquipItemButtons', true),

  // Features
  LockAvailableItemFeatureUses: new BooleanSetting('lockAvailableItemFeatureUses', true),

  // Spellbook
  LockPrepareSpellButtons: new BooleanSetting('lockPrepareSpellButtons', true),
  LockAvailableSpellSlots: new BooleanSetting('lockAvailableSpellSlots', true),
  LockMaxSpellSlotOverride: new BooleanSetting('lockMaxSpellSlotOverride', true),

  // Effects
  LockEffects: new BooleanSetting('lockEffects', true, { hasHint: true }),
  ...
  DisableTidy5eSheet: new BooleanSetting('disableTidy5eSheet', true, { hasHint: true }),
